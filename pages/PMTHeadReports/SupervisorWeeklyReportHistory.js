...
export default function SupervisorWeeklyReportHistory() {
  ...
  useEffect(() => {
    const fetch = onSnapshot(
      collection(db, "PMTReports/SupervisorReports/Weekly"),
      (snapshot) => {
  ...
  function handleExportToExcel(date) {
    ...
    XLSX.writeFile(workBook, `PMT-Supervisor-Weekly-Report-${date}.xlsx`);
  }
        ...
        <div>
          ...
          <div className="flex flex-col items-center">
            <p className=" text-2xl md:text-3xl mb-4">
              Site Supervisor Weekly Report History
            </p>
          </div>
